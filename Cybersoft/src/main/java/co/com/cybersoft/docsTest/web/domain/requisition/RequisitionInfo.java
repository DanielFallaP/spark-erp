...
public class RequisitionInfo implements Serializable{
	...
	public RequisitionInfo toRequisitionInfo(Requisition entity){
		...
		List<RequisitionBodyInfo> bodyList = new ArrayList<RequisitionBodyInfo>();
		List<RequisitionBody> requisitionItemEntityList = entity.getRequisitionBodyEntityList();
		for (RequisitionBody requisitionItem : requisitionItemEntityList) {
			RequisitionBodyInfo requisitionItemInfo = new RequisitionBodyInfo();
			BeanUtils.copyProperties(requisitionItem, requisitionItemInfo);
			bodyList.add(requisitionItemInfo);
			this.setRequisitionBodyList(bodyList);
		}
		return this;
	}
