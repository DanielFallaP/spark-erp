...
public class CurrencyCodeReportingServiceImpl implements CurrencyCodeReportingService {
	@Autowired
	...
	@Autowired
	private CurrencyCodeService currencyCode;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CurrencyCodeFilterInfo filter) throws Exception {
		...
		RequestCurrencyCodePageEvent pageEvent=new RequestCurrencyCodePageEvent(pageRequest,filter);			

		CurrencyCodePageEvent requestCurrencyCodeFilter = currencyCode.requestCurrencyCodeFilter(pageEvent);
		
		return generateExcel(requestCurrencyCodeFilter.getAllList(), forName, forNameDetails, locale);
	}	
