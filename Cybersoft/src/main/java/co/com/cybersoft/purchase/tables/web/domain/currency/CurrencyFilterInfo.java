...
public class CurrencyFilterInfo {
	...
	private List<CurrencyFilterInfo> currencyFilterList=new ArrayList<CurrencyFilterInfo>();
	
	public List<CurrencyFilterInfo> getCurrencyFilterList() {
		return currencyFilterList;
	}

	public void setCurrencyFilterList(
			List<CurrencyFilterInfo> currencyFilterList) {
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (CurrencyFilterInfo fil : currencyFilterList) {
		...
		if (code!=null && !code.equals(""))ffilterAsText+=code+" ";if (currency!=null && !currency.equals(""))ffilterAsText+=currency+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
