...
public class CustomerTenancyReportingServiceImpl implements CustomerTenancyReportingService {
	@Autowired
	...
	@Autowired
	private CustomerTenancyService customerTenancy;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CustomerTenancyFilterInfo filter) throws Exception {
		...
		RequestCustomerTenancyPageEvent pageEvent=new RequestCustomerTenancyPageEvent(pageRequest,filter);			

		CustomerTenancyPageEvent requestCustomerTenancyFilter = customerTenancy.requestCustomerTenancyFilter(pageEvent);
		
		return generateExcel(requestCustomerTenancyFilter.getAllList(), forName, forNameDetails, locale);
	}	
