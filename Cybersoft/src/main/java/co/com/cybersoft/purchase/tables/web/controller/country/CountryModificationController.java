...
public class CountryModificationController {
	...
	public String modifyCountry(@PathVariable("id") Long id, @Valid @ModelAttribute("countryInfo") CountryInfo countryInfo, HttpServletRequest request) throws Exception {
