...
public class TypeCauseCloseReportingServiceImpl implements TypeCauseCloseReportingService {
	@Autowired
	...
	@Autowired
	private TypeCauseCloseService typeCauseClose;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, TypeCauseCloseFilterInfo filter) throws Exception {
		...
		RequestTypeCauseClosePageEvent pageEvent=new RequestTypeCauseClosePageEvent(pageRequest,filter);			

		TypeCauseClosePageEvent requestTypeCauseCloseFilter = typeCauseClose.requestTypeCauseCloseFilter(pageEvent);
		
		return generateExcel(requestTypeCauseCloseFilter.getAllList(), forName, forNameDetails, locale);
	}	
