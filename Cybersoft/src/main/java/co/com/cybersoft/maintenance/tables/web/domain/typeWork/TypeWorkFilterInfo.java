package co.com.cybersoft.maintenance.tables.web.domain.typeWork;
...
public class TypeWorkFilterInfo {
	...
	private List<TypeWorkFilterInfo> typeWorkFilterList=new ArrayList<TypeWorkFilterInfo>();
	
	public List<TypeWorkFilterInfo> getTypeWorkFilterList() {
		return typeWorkFilterList;
	}

	public void setTypeWorkFilterList(
			List<TypeWorkFilterInfo> typeWorkFilterList) {
		this.typeWorkFilterList = typeWorkFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (TypeWorkFilterInfo fil : typeWorkFilterList) {
		...
		if (typeWork!=null && !typeWork.equals(""))ffilterAsText+=typeWork+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
