...
public class StateDetails {
	...
	public StateDetails toStateDetails(State entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = StateDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.nameState=nameState+_embedded;
