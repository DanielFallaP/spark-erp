 ...
 *
 */
public class TypeCauseCloseDetails {
	...
	public TypeCauseCloseDetails toTypeCauseCloseDetails(TypeCauseClose entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = TypeCauseCloseDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.typeCauseClose=typeCauseClose+_embedded;
