...
public class ConceptKardexReportingServiceImpl implements ConceptKardexReportingService {
	@Autowired
	...
	@Autowired
	private ConceptKardexService conceptKardex;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, ConceptKardexFilterInfo filter) throws Exception {
		...
		RequestConceptKardexPageEvent pageEvent=new RequestConceptKardexPageEvent(pageRequest,filter);			

		ConceptKardexPageEvent requestConceptKardexFilter = conceptKardex.requestConceptKardexFilter(pageEvent);
		
		return generateExcel(requestConceptKardexFilter.getAllList(), forName, forNameDetails, locale);
	}	
