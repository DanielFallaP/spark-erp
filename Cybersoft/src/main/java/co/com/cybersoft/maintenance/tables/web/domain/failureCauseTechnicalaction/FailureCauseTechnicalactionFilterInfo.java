...
public class FailureCauseTechnicalactionFilterInfo {
	...
	private String orderFailureCauseTechnicalactions;


	public String getOrderFailureCauseTechnicalactions() {
		return orderFailureCauseTechnicalactions;	
	}
		
	public void setOrderFailureCauseTechnicalactions(String orderFailureCauseTechnicalactions) {
	...
	private List<FailureCauseTechnicalactionFilterInfo> failureCauseTechnicalactionFilterList=new ArrayList<FailureCauseTechnicalactionFilterInfo>();
	
	public List<FailureCauseTechnicalactionFilterInfo> getFailureCauseTechnicalactionFilterList() {
		return failureCauseTechnicalactionFilterList;
	}

	public void setFailureCauseTechnicalactionFilterList(
			List<FailureCauseTechnicalactionFilterInfo> failureCauseTechnicalactionFilterList) {
		this.failureCauseTechnicalactionFilterList = failureCauseTechnicalactionFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (FailureCauseTechnicalactionFilterInfo fil : failureCauseTechnicalactionFilterList) {
			ffilterAsText+=(index!=0?(fil.getFffilterNature().equals(CyberUtils.filterUnion)?" UNION ":" MINUS "):"");
			if (fil.getFailureCause()!=null && !fil.getFailureCause().equals(""))ffilterAsText+=fil.getFailureCause()+" ";
			if (fil.getTechnicalAction()!=null && !fil.getTechnicalAction().equals(""))ffilterAsText+=fil.getTechnicalAction()+" ";
			if (fil.getOrderFailureCauseTechnicalactions()!=null && !fil.getOrderFailureCauseTechnicalactions().equals(""))ffilterAsText+=fil.getOrderFailureCauseTechnicalactions()+" ";
		...
		if (failureCause!=null && !failureCause.equals(""))ffilterAsText+=failureCause+" ";if (technicalAction!=null && !technicalAction.equals(""))ffilterAsText+=technicalAction+" ";if (orderFailureCauseTechnicalactions!=null && !orderFailureCauseTechnicalactions.equals(""))ffilterAsText+=orderFailureCauseTechnicalactions+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
