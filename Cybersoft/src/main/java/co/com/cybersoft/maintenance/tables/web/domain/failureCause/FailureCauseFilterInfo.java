package co.com.cybersoft.maintenance.tables.web.domain.failureCause;
...
public class FailureCauseFilterInfo {
	...
	private String nameFailureCause;


	public String getNameFailureCause() {
		return nameFailureCause;	
	}
		
	public void setNameFailureCause(String nameFailureCause) {
		this.nameFailureCause = nameFailureCause;	
	}
	...
	private List<FailureCauseFilterInfo> failureCauseFilterList=new ArrayList<FailureCauseFilterInfo>();
	
	public List<FailureCauseFilterInfo> getFailureCauseFilterList() {
		return failureCauseFilterList;
	}

	public void setFailureCauseFilterList(
			List<FailureCauseFilterInfo> failureCauseFilterList) {
		this.failureCauseFilterList = failureCauseFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (FailureCauseFilterInfo fil : failureCauseFilterList) {
			...
			if (fil.getNameFailureCause()!=null && !fil.getNameFailureCause().equals(""))ffilterAsText+=fil.getNameFailureCause()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameFailureCause!=null && !nameFailureCause.equals(""))ffilterAsText+=nameFailureCause+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
