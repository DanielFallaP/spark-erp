...
public class TypeMaintenanceReportingServiceImpl implements TypeMaintenanceReportingService {
	@Autowired
	...
	@Autowired
	private TypeMaintenanceService typeMaintenance;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, TypeMaintenanceFilterInfo filter) throws Exception {
		...
		RequestTypeMaintenancePageEvent pageEvent=new RequestTypeMaintenancePageEvent(pageRequest,filter);			

		TypeMaintenancePageEvent requestTypeMaintenanceFilter = typeMaintenance.requestTypeMaintenanceFilter(pageEvent);
		
		return generateExcel(requestTypeMaintenanceFilter.getAllList(), forName, forNameDetails, locale);
	}	
