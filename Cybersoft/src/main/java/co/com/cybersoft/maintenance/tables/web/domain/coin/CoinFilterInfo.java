...
public class CoinFilterInfo {
	...
	private List<CoinFilterInfo> coinFilterList=new ArrayList<CoinFilterInfo>();
	
	public List<CoinFilterInfo> getCoinFilterList() {
		return coinFilterList;
	}

	public void setCoinFilterList(
			List<CoinFilterInfo> coinFilterList) {
		this.coinFilterList = coinFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (CoinFilterInfo fil : coinFilterList) {
			...
			if (fil.getNameCoin()!=null && !fil.getNameCoin().equals(""))ffilterAsText+=fil.getNameCoin()+" ";
			if (fil.getAbbreviationCurrency()!=null && !fil.getAbbreviationCurrency().equals(""))ffilterAsText+=fil.getAbbreviationCurrency()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameCoin!=null && !nameCoin.equals(""))ffilterAsText+=nameCoin+" ";if (abbreviationCurrency!=null && !abbreviationCurrency.equals(""))ffilterAsText+=abbreviationCurrency+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
