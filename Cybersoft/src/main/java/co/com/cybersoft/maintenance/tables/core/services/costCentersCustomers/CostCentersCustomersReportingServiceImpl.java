...
public class CostCentersCustomersReportingServiceImpl implements CostCentersCustomersReportingService {
	@Autowired
	...
	@Autowired
	private CostCentersCustomersService costCentersCustomers;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CostCentersCustomersFilterInfo filter) throws Exception {
		...
		RequestCostCentersCustomersPageEvent pageEvent=new RequestCostCentersCustomersPageEvent(pageRequest,filter);			

		CostCentersCustomersPageEvent requestCostCentersCustomersFilter = costCentersCustomers.requestCostCentersCustomersFilter(pageEvent);
		
		return generateExcel(requestCostCentersCustomersFilter.getAllList(), forName, forNameDetails, locale);
	}	
