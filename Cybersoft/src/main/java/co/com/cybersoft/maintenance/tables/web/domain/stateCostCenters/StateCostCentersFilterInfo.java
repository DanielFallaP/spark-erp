package co.com.cybersoft.maintenance.tables.web.domain.stateCostCenters;
...
public class StateCostCentersFilterInfo {
	...
	private String stateCostCenters;


	public String getStateCostCenters() {
		return stateCostCenters;	
	}
		
	public void setStateCostCenters(String stateCostCenters) {
		this.stateCostCenters = stateCostCenters;	
	}
	...
	private List<StateCostCentersFilterInfo> stateCostCentersFilterList=new ArrayList<StateCostCentersFilterInfo>();
	
	public List<StateCostCentersFilterInfo> getStateCostCentersFilterList() {
		return stateCostCentersFilterList;
	}

	public void setStateCostCentersFilterList(
			List<StateCostCentersFilterInfo> stateCostCentersFilterList) {
		this.stateCostCentersFilterList = stateCostCentersFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (StateCostCentersFilterInfo fil : stateCostCentersFilterList) {
			ffilterAsText+=(index!=0?(fil.getFffilterNature().equals(CyberUtils.filterUnion)?" UNION ":" MINUS "):"");
			if (fil.getStateCostCenters()!=null && !fil.getStateCostCenters().equals(""))ffilterAsText+=fil.getStateCostCenters()+" ";
		...
		if (stateCostCenters!=null && !stateCostCenters.equals(""))ffilterAsText+=stateCostCenters+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
