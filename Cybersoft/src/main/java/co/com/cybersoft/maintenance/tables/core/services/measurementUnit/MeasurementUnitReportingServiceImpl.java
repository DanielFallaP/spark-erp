...
public class MeasurementUnitReportingServiceImpl implements MeasurementUnitReportingService {
	@Autowired
	...
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, MeasurementUnitFilterInfo filter) throws Exception {
		...
		RequestMeasurementUnitPageEvent pageEvent=new RequestMeasurementUnitPageEvent(pageRequest,filter);			

		MeasurementUnitPageEvent requestMeasurementUnitFilter = measurementUnit.requestMeasurementUnitFilter(pageEvent);
		
		return generateExcel(requestMeasurementUnitFilter.getAllList(), forName, forNameDetails, locale);
	}	
