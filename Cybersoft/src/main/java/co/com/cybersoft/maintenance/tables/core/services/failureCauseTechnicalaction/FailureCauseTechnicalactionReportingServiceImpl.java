...
public class FailureCauseTechnicalactionReportingServiceImpl implements FailureCauseTechnicalactionReportingService {
	@Autowired
	...
	@Autowired
	private FailureCauseTechnicalactionService failureCauseTechnicalaction;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, FailureCauseTechnicalactionFilterInfo filter) throws Exception {
		...
		RequestFailureCauseTechnicalactionPageEvent pageEvent=new RequestFailureCauseTechnicalactionPageEvent(pageRequest,filter);			

		FailureCauseTechnicalactionPageEvent requestFailureCauseTechnicalactionFilter = failureCauseTechnicalaction.requestFailureCauseTechnicalactionFilter(pageEvent);
		
		return generateExcel(requestFailureCauseTechnicalactionFilter.getAllList(), forName, forNameDetails, locale);
	}	
