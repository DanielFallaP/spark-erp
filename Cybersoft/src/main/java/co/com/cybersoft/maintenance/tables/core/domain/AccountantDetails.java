...
public class AccountantDetails {
	...
	public AccountantDetails toAccountantDetails(Accountant entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = AccountantDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.nameAccountant=nameAccountant+_embedded;
