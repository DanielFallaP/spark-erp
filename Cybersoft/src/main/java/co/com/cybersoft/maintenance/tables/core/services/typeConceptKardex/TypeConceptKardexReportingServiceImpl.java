...
public class TypeConceptKardexReportingServiceImpl implements TypeConceptKardexReportingService {
	@Autowired
	...
	@Autowired
	private TypeConceptKardexService typeConceptKardex;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, TypeConceptKardexFilterInfo filter) throws Exception {
		...
		RequestTypeConceptKardexPageEvent pageEvent=new RequestTypeConceptKardexPageEvent(pageRequest,filter);			

		TypeConceptKardexPageEvent requestTypeConceptKardexFilter = typeConceptKardex.requestTypeConceptKardexFilter(pageEvent);
		
		return generateExcel(requestTypeConceptKardexFilter.getAllList(), forName, forNameDetails, locale);
	}	
