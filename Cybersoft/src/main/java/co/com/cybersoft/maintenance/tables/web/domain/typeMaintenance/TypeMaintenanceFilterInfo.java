package co.com.cybersoft.maintenance.tables.web.domain.typeMaintenance;
...
public class TypeMaintenanceFilterInfo {
	...
	private String nameTypeMaintenance;


	public String getNameTypeMaintenance() {
		return nameTypeMaintenance;	
	}
		
	public void setNameTypeMaintenance(String nameTypeMaintenance) {
		this.nameTypeMaintenance = nameTypeMaintenance;	
	}
	...
	private List<TypeMaintenanceFilterInfo> typeMaintenanceFilterList=new ArrayList<TypeMaintenanceFilterInfo>();
	
	public List<TypeMaintenanceFilterInfo> getTypeMaintenanceFilterList() {
		return typeMaintenanceFilterList;
	}

	public void setTypeMaintenanceFilterList(
			List<TypeMaintenanceFilterInfo> typeMaintenanceFilterList) {
		this.typeMaintenanceFilterList = typeMaintenanceFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (TypeMaintenanceFilterInfo fil : typeMaintenanceFilterList) {
			...
			if (fil.getNameTypeMaintenance()!=null && !fil.getNameTypeMaintenance().equals(""))ffilterAsText+=fil.getNameTypeMaintenance()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameTypeMaintenance!=null && !nameTypeMaintenance.equals(""))ffilterAsText+=nameTypeMaintenance+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
