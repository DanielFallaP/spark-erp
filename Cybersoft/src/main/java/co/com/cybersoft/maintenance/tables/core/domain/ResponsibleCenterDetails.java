 ...
 *
 */
public class ResponsibleCenterDetails {
	...
	public ResponsibleCenterDetails toResponsibleCenterDetails(ResponsibleCenter entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = ResponsibleCenterDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.nameResponsibleCenter=nameResponsibleCenter+_embedded;
