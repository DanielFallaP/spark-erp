 ...
 *
 */
public class TypeConceptKardexDetails {
	...
	public TypeConceptKardexDetails toTypeConceptKardexDetails(TypeConceptKardex entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = TypeConceptKardexDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.typeConceptKardex=typeConceptKardex+_embedded;
