...
public class CoinReportingServiceImpl implements CoinReportingService {
	@Autowired
	...
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CoinFilterInfo filter) throws Exception {
		...
		RequestCoinPageEvent pageEvent=new RequestCoinPageEvent(pageRequest,filter);			

		CoinPageEvent requestCoinFilter = coin.requestCoinFilter(pageEvent);
		
		return generateExcel(requestCoinFilter.getAllList(), forName, forNameDetails, locale);
	}	
