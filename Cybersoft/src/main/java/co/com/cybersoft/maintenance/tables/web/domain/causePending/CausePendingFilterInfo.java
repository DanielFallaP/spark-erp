package co.com.cybersoft.maintenance.tables.web.domain.causePending;
...
public class CausePendingFilterInfo {
	...
	private List<CausePendingFilterInfo> causePendingFilterList=new ArrayList<CausePendingFilterInfo>();
	
	public List<CausePendingFilterInfo> getCausePendingFilterList() {
		return causePendingFilterList;
	}

	public void setCausePendingFilterList(
			List<CausePendingFilterInfo> causePendingFilterList) {
		this.causePendingFilterList = causePendingFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (CausePendingFilterInfo fil : causePendingFilterList) {
			...
			if (fil.getNameCausePending()!=null && !fil.getNameCausePending().equals(""))ffilterAsText+=fil.getNameCausePending()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameCausePending!=null && !nameCausePending.equals(""))ffilterAsText+=nameCausePending+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
