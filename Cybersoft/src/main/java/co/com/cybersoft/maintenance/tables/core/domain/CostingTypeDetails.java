 ...
 *
 */
public class CostingTypeDetails {
	...
	public CostingTypeDetails toCostingTypeDetails(CostingType entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = CostingTypeDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.costingType=costingType+_embedded;
