package co.com.cybersoft.maintenance.tables.web.domain.operation;
...
public class OperationFilterInfo {
	...
	private List<OperationFilterInfo> operationFilterList=new ArrayList<OperationFilterInfo>();
	
	public List<OperationFilterInfo> getOperationFilterList() {
		return operationFilterList;
	}

	public void setOperationFilterList(
			List<OperationFilterInfo> operationFilterList) {
		this.operationFilterList = operationFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (OperationFilterInfo fil : operationFilterList) {
			...
			if (fil.getCodeOperation()!=null && !fil.getCodeOperation().equals(""))ffilterAsText+=fil.getCodeOperation()+" ";
			if (fil.getNameOperation()!=null && !fil.getNameOperation().equals(""))ffilterAsText+=fil.getNameOperation()+" ";
			if (fil.getStateOperation()!=null && !fil.getStateOperation().equals(""))ffilterAsText+=fil.getStateOperation()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (codeOperation!=null && !codeOperation.equals(""))ffilterAsText+=codeOperation+" ";if (nameOperation!=null && !nameOperation.equals(""))ffilterAsText+=nameOperation+" ";if (stateOperation!=null && !stateOperation.equals(""))ffilterAsText+=stateOperation+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
