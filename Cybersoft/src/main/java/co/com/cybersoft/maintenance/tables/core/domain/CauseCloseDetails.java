 ...
 *
 */
public class CauseCloseDetails {
	...
	public CauseCloseDetails toCauseCloseDetails(CauseClose entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = CauseCloseDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.nameCauseClose=nameCauseClose+_embedded;
		this.typeCauseClose=entity.getTypeCauseClose().getTypeCauseClose()+_embedded;
		this.typeCauseCloseId=entity.getTypeCauseClose().getId();
