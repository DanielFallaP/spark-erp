...
public class CauseCloseReportingServiceImpl implements CauseCloseReportingService {
	@Autowired
	...
	@Autowired
	private CauseCloseService causeClose;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CauseCloseFilterInfo filter) throws Exception {
		...
		RequestCauseClosePageEvent pageEvent=new RequestCauseClosePageEvent(pageRequest,filter);			

		CauseClosePageEvent requestCauseCloseFilter = causeClose.requestCauseCloseFilter(pageEvent);
		
		return generateExcel(requestCauseCloseFilter.getAllList(), forName, forNameDetails, locale);
	}	
