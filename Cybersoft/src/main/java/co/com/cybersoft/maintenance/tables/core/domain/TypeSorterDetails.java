 ...
 *
 */
public class TypeSorterDetails {
	...
	public TypeSorterDetails toTypeSorterDetails(TypeSorter entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = TypeSorterDetails.class.getMethod("get"+embeddedField.getName());
		...
		this.nameTypeSorter=nameTypeSorter+_embedded;
