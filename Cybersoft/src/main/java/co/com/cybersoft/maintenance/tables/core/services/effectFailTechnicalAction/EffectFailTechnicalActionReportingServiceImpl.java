...
public class EffectFailTechnicalActionReportingServiceImpl implements EffectFailTechnicalActionReportingService {
	@Autowired
	...
	@Autowired
	private EffectFailTechnicalActionService effectFailTechnicalAction;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, EffectFailTechnicalActionFilterInfo filter) throws Exception {
		...
		RequestEffectFailTechnicalActionPageEvent pageEvent=new RequestEffectFailTechnicalActionPageEvent(pageRequest,filter);			

		EffectFailTechnicalActionPageEvent requestEffectFailTechnicalActionFilter = effectFailTechnicalAction.requestEffectFailTechnicalActionFilter(pageEvent);
		
		return generateExcel(requestEffectFailTechnicalActionFilter.getAllList(), forName, forNameDetails, locale);
	}	
