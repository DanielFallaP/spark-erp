...
public class SorterFilterInfo {
	...
	private List<SorterFilterInfo> sorterFilterList=new ArrayList<SorterFilterInfo>();
	
	public List<SorterFilterInfo> getSorterFilterList() {
		return sorterFilterList;
	}

	public void setSorterFilterList(
			List<SorterFilterInfo> sorterFilterList) {
		this.sorterFilterList = sorterFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (SorterFilterInfo fil : sorterFilterList) {
			...
			if (fil.getTypeSorter()!=null && !fil.getTypeSorter().equals(""))ffilterAsText+=fil.getTypeSorter()+" ";
			if (fil.getNameSorter()!=null && !fil.getNameSorter().equals(""))ffilterAsText+=fil.getNameSorter()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (typeSorter!=null && !typeSorter.equals(""))ffilterAsText+=typeSorter+" ";if (nameSorter!=null && !nameSorter.equals(""))ffilterAsText+=nameSorter+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
