...
public class StateCostCentersReportingServiceImpl implements StateCostCentersReportingService {
	@Autowired
	...
	@Autowired
	private StateCostCentersService stateCostCenters;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, StateCostCentersFilterInfo filter) throws Exception {
		...
		RequestStateCostCentersPageEvent pageEvent=new RequestStateCostCentersPageEvent(pageRequest,filter);			

		StateCostCentersPageEvent requestStateCostCentersFilter = stateCostCenters.requestStateCostCentersFilter(pageEvent);
		
		return generateExcel(requestStateCostCentersFilter.getAllList(), forName, forNameDetails, locale);
	}	
