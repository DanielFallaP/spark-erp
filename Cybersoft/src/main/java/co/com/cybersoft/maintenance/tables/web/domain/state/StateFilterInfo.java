package co.com.cybersoft.maintenance.tables.web.domain.state;
...
public class StateFilterInfo {
	...
	private List<StateFilterInfo> stateFilterList=new ArrayList<StateFilterInfo>();
	
	public List<StateFilterInfo> getStateFilterList() {
		return stateFilterList;
	}

	public void setStateFilterList(
			List<StateFilterInfo> stateFilterList) {
		this.stateFilterList = stateFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (StateFilterInfo fil : stateFilterList) {
			...
			if (fil.getNameState()!=null && !fil.getNameState().equals(""))ffilterAsText+=fil.getNameState()+" ";
			if (fil.getTypeState()!=null && !fil.getTypeState().equals(""))ffilterAsText+=fil.getTypeState()+" ";
			if (fil.getClassState()!=null && !fil.getClassState().equals(""))ffilterAsText+=fil.getClassState()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameState!=null && !nameState.equals(""))ffilterAsText+=nameState+" ";if (typeState!=null && !typeState.equals(""))ffilterAsText+=typeState+" ";if (classState!=null && !classState.equals(""))ffilterAsText+=classState+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
