...
public class CauseCloseFilterInfo {
	...
	private List<CauseCloseFilterInfo> causeCloseFilterList=new ArrayList<CauseCloseFilterInfo>();
	
	public List<CauseCloseFilterInfo> getCauseCloseFilterList() {
		return causeCloseFilterList;
	}

	public void setCauseCloseFilterList(
			List<CauseCloseFilterInfo> causeCloseFilterList) {
		this.causeCloseFilterList = causeCloseFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (CauseCloseFilterInfo fil : causeCloseFilterList) {
			...
			if (fil.getNameCauseClose()!=null && !fil.getNameCauseClose().equals(""))ffilterAsText+=fil.getNameCauseClose()+" ";
			if (fil.getTypeCauseClose()!=null && !fil.getTypeCauseClose().equals(""))ffilterAsText+=fil.getTypeCauseClose()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameCauseClose!=null && !nameCauseClose.equals(""))ffilterAsText+=nameCauseClose+" ";if (typeCauseClose!=null && !typeCauseClose.equals(""))ffilterAsText+=typeCauseClose+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
