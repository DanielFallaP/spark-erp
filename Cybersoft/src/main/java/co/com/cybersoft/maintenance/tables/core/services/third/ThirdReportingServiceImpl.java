...
public class ThirdReportingServiceImpl implements ThirdReportingService {
	@Autowired
	...
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, ThirdFilterInfo filter) throws Exception {
		...
		RequestThirdPageEvent pageEvent=new RequestThirdPageEvent(pageRequest,filter);			

		ThirdPageEvent requestThirdFilter = third.requestThirdFilter(pageEvent);
		
		return generateExcel(requestThirdFilter.getAllList(), forName, forNameDetails, locale);
	}	
