...
public class AuthorizerCostCenterReportingServiceImpl implements AuthorizerCostCenterReportingService {
	@Autowired
	...
	@Autowired
	private AuthorizerCostCenterService authorizerCostCenter;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, AuthorizerCostCenterFilterInfo filter) throws Exception {
		...
		RequestAuthorizerCostCenterPageEvent pageEvent=new RequestAuthorizerCostCenterPageEvent(pageRequest,filter);			

		AuthorizerCostCenterPageEvent requestAuthorizerCostCenterFilter = authorizerCostCenter.requestAuthorizerCostCenterFilter(pageEvent);
		
		return generateExcel(requestAuthorizerCostCenterFilter.getAllList(), forName, forNameDetails, locale);
	}	
