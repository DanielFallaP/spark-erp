package co.com.cybersoft.maintenance.tables.web.domain.characteristic;
...
public class CharacteristicFilterInfo {
	...
	private List<CharacteristicFilterInfo> characteristicFilterList=new ArrayList<CharacteristicFilterInfo>();
	
	public List<CharacteristicFilterInfo> getCharacteristicFilterList() {
		return characteristicFilterList;
	}

	public void setCharacteristicFilterList(
			List<CharacteristicFilterInfo> characteristicFilterList) {
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (CharacteristicFilterInfo fil : characteristicFilterList) {
			...
			if (fil.getNameCharacteristic()!=null && !fil.getNameCharacteristic().equals(""))ffilterAsText+=fil.getNameCharacteristic()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameCharacteristic!=null && !nameCharacteristic.equals(""))ffilterAsText+=nameCharacteristic+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
