...
public class AccountantFilterInfo {
	...
	private List<AccountantFilterInfo> accountantFilterList=new ArrayList<AccountantFilterInfo>();
	
	public List<AccountantFilterInfo> getAccountantFilterList() {
		return accountantFilterList;
	}

	public void setAccountantFilterList(
			List<AccountantFilterInfo> accountantFilterList) {
		this.accountantFilterList = accountantFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (AccountantFilterInfo fil : accountantFilterList) {
			...
			if (fil.getNameAccountant()!=null && !fil.getNameAccountant().equals(""))ffilterAsText+=fil.getNameAccountant()+" ";
			if (fil.getNumber()!=null && !fil.getNumber().equals(""))ffilterAsText+=fil.getNumber()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameAccountant!=null && !nameAccountant.equals(""))ffilterAsText+=nameAccountant+" ";if (number!=null && !number.equals(""))ffilterAsText+=number+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
