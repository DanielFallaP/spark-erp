...
public class StoreTypeDetails {
	...
	public StoreTypeDetails toStoreTypeDetails(StoreType entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = StoreTypeDetails.class.getMethod("get"+embeddedField.getName());
