...
public class PhysicalLocationReportingServiceImpl implements PhysicalLocationReportingService {
	@Autowired
	...
	@Autowired
	private PhysicalLocationService physicalLocation;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, PhysicalLocationFilterInfo filter) throws Exception {
		...
		RequestPhysicalLocationPageEvent pageEvent=new RequestPhysicalLocationPageEvent(pageRequest,filter);			

		PhysicalLocationPageEvent requestPhysicalLocationFilter = physicalLocation.requestPhysicalLocationFilter(pageEvent);
		
		return generateExcel(requestPhysicalLocationFilter.getAllList(), forName, forNameDetails, locale);
	}	
