...
public class CharacteristicReportingServiceImpl implements CharacteristicReportingService {
	@Autowired
	...
	@Autowired
	private CharacteristicService characteristic;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, CharacteristicFilterInfo filter) throws Exception {
		...
		RequestCharacteristicPageEvent pageEvent=new RequestCharacteristicPageEvent(pageRequest,filter);			

		CharacteristicPageEvent requestCharacteristicFilter = characteristic.requestCharacteristicFilter(pageEvent);
		
		return generateExcel(requestCharacteristicFilter.getAllList(), forName, forNameDetails, locale);
	}	
