...
public class ReferenceOperationReportingServiceImpl implements ReferenceOperationReportingService {
	@Autowired
	...
	@Autowired
	private ReferenceOperationService referenceOperation;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, ReferenceOperationFilterInfo filter) throws Exception {
		...
		RequestReferenceOperationPageEvent pageEvent=new RequestReferenceOperationPageEvent(pageRequest,filter);			

		ReferenceOperationPageEvent requestReferenceOperationFilter = referenceOperation.requestReferenceOperationFilter(pageEvent);
		
		return generateExcel(requestReferenceOperationFilter.getAllList(), forName, forNameDetails, locale);
	}	
