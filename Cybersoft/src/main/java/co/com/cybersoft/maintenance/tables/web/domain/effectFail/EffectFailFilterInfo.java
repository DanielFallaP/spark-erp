package co.com.cybersoft.maintenance.tables.web.domain.effectFail;
...
public class EffectFailFilterInfo {
	...
	private String effectFailName;


	public String getEffectFailName() {
		return effectFailName;	
	}
		
	public void setEffectFailName(String effectFailName) {
		this.effectFailName = effectFailName;	
	}
	...
	private List<EffectFailFilterInfo> effectFailFilterList=new ArrayList<EffectFailFilterInfo>();
	
	public List<EffectFailFilterInfo> getEffectFailFilterList() {
		return effectFailFilterList;
	}

	public void setEffectFailFilterList(
			List<EffectFailFilterInfo> effectFailFilterList) {
		this.effectFailFilterList = effectFailFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (EffectFailFilterInfo fil : effectFailFilterList) {
			...
			if (fil.getEffectFailName()!=null && !fil.getEffectFailName().equals(""))ffilterAsText+=fil.getEffectFailName()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (effectFailName!=null && !effectFailName.equals(""))ffilterAsText+=effectFailName+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
