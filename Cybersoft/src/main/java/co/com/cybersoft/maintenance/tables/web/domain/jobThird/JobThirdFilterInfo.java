...
public class JobThirdFilterInfo {
	...
	private String stateJobThird;


	public String getStateJobThird() {
		return stateJobThird;	
	}
		
	public void setStateJobThird(String stateJobThird) {
	...
	private List<JobThirdFilterInfo> jobThirdFilterList=new ArrayList<JobThirdFilterInfo>();
	
	public List<JobThirdFilterInfo> getJobThirdFilterList() {
		return jobThirdFilterList;
	}

	public void setJobThirdFilterList(
			List<JobThirdFilterInfo> jobThirdFilterList) {
		this.jobThirdFilterList = jobThirdFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (JobThirdFilterInfo fil : jobThirdFilterList) {
			ffilterAsText+=(index!=0?(fil.getFffilterNature().equals(CyberUtils.filterUnion)?" UNION ":" MINUS "):"");
			if (fil.getJob()!=null && !fil.getJob().equals(""))ffilterAsText+=fil.getJob()+" ";
			if (fil.getThird()!=null && !fil.getThird().equals(""))ffilterAsText+=fil.getThird()+" ";
			if (fil.getStateJobThird()!=null && !fil.getStateJobThird().equals(""))ffilterAsText+=fil.getStateJobThird()+" ";
		...
		if (job!=null && !job.equals(""))ffilterAsText+=job+" ";if (third!=null && !third.equals(""))ffilterAsText+=third+" ";if (stateJobThird!=null && !stateJobThird.equals(""))ffilterAsText+=stateJobThird+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
