...
public class TechnicalActionFilterInfo {
	...
	private List<TechnicalActionFilterInfo> technicalActionFilterList=new ArrayList<TechnicalActionFilterInfo>();
	
	public List<TechnicalActionFilterInfo> getTechnicalActionFilterList() {
		return technicalActionFilterList;
	}

	public void setTechnicalActionFilterList(
			List<TechnicalActionFilterInfo> technicalActionFilterList) {
		this.technicalActionFilterList = technicalActionFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (TechnicalActionFilterInfo fil : technicalActionFilterList) {
			...
			if (fil.getTechnicalActionName()!=null && !fil.getTechnicalActionName().equals(""))ffilterAsText+=fil.getTechnicalActionName()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (code!=null && !code.equals(""))ffilterAsText+=code+" ";if (technicalActionName!=null && !technicalActionName.equals(""))ffilterAsText+=technicalActionName+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
