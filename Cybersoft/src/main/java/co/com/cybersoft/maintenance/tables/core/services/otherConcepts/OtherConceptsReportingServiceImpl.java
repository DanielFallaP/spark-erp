...
public class OtherConceptsReportingServiceImpl implements OtherConceptsReportingService {
	@Autowired
	...
	@Autowired
	private OtherConceptsService otherConcepts;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, OtherConceptsFilterInfo filter) throws Exception {
		...
		RequestOtherConceptsPageEvent pageEvent=new RequestOtherConceptsPageEvent(pageRequest,filter);			

		OtherConceptsPageEvent requestOtherConceptsFilter = otherConcepts.requestOtherConceptsFilter(pageEvent);
		
		return generateExcel(requestOtherConceptsFilter.getAllList(), forName, forNameDetails, locale);
	}	
