package co.com.cybersoft.maintenance.tables.web.domain.typeCauseClose;
...
public class TypeCauseCloseFilterInfo {
	...
	private List<TypeCauseCloseFilterInfo> typeCauseCloseFilterList=new ArrayList<TypeCauseCloseFilterInfo>();
	
	public List<TypeCauseCloseFilterInfo> getTypeCauseCloseFilterList() {
		return typeCauseCloseFilterList;
	}

	public void setTypeCauseCloseFilterList(
			List<TypeCauseCloseFilterInfo> typeCauseCloseFilterList) {
		this.typeCauseCloseFilterList = typeCauseCloseFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (TypeCauseCloseFilterInfo fil : typeCauseCloseFilterList) {
		...
		if (typeCauseClose!=null && !typeCauseClose.equals(""))ffilterAsText+=typeCauseClose+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
