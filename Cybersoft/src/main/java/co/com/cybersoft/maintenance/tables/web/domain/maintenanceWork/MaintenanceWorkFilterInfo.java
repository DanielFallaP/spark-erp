package co.com.cybersoft.maintenance.tables.web.domain.maintenanceWork;
...
public class MaintenanceWorkFilterInfo {
	...
	private List<MaintenanceWorkFilterInfo> maintenanceWorkFilterList=new ArrayList<MaintenanceWorkFilterInfo>();
	
	public List<MaintenanceWorkFilterInfo> getMaintenanceWorkFilterList() {
		return maintenanceWorkFilterList;
	}

	public void setMaintenanceWorkFilterList(
			List<MaintenanceWorkFilterInfo> maintenanceWorkFilterList) {
		this.maintenanceWorkFilterList = maintenanceWorkFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (MaintenanceWorkFilterInfo fil : maintenanceWorkFilterList) {
			...
			if (fil.getNameMaintenanceWork()!=null && !fil.getNameMaintenanceWork().equals(""))ffilterAsText+=fil.getNameMaintenanceWork()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (nameMaintenanceWork!=null && !nameMaintenanceWork.equals(""))ffilterAsText+=nameMaintenanceWork+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
