...
public class OtherConceptsInfo implements Serializable{
	...
	private List<MeasurementUnitDetails> unitMeasureList;
	...
	public List<MeasurementUnitDetails> getUnitMeasureList() {
		return unitMeasureList;
	}
	public void setUnitMeasureList(
				List<MeasurementUnitDetails> unitMeasureList) {
