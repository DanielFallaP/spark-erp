...
public class MaintenanceWorkReportingServiceImpl implements MaintenanceWorkReportingService {
	@Autowired
	...
	@Autowired
	private MaintenanceWorkService maintenanceWork;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, MaintenanceWorkFilterInfo filter) throws Exception {
		...
		RequestMaintenanceWorkPageEvent pageEvent=new RequestMaintenanceWorkPageEvent(pageRequest,filter);			

		MaintenanceWorkPageEvent requestMaintenanceWorkFilter = maintenanceWork.requestMaintenanceWorkFilter(pageEvent);
		
		return generateExcel(requestMaintenanceWorkFilter.getAllList(), forName, forNameDetails, locale);
	}	
