...
public class ReferenceFilterInfo {
	...
	public void setStateReference(String stateReference) {
	...
	private List<ReferenceFilterInfo> referenceFilterList=new ArrayList<ReferenceFilterInfo>();
	
	public List<ReferenceFilterInfo> getReferenceFilterList() {
		return referenceFilterList;
	}

	public void setReferenceFilterList(
			List<ReferenceFilterInfo> referenceFilterList) {
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (ReferenceFilterInfo fil : referenceFilterList) {
			...
			if (fil.getCodeReference()!=null && !fil.getCodeReference().equals(""))ffilterAsText+=fil.getCodeReference()+" ";
			if (fil.getNameReference()!=null && !fil.getNameReference().equals(""))ffilterAsText+=fil.getNameReference()+" ";
			if (fil.getStateReference()!=null && !fil.getStateReference().equals(""))ffilterAsText+=fil.getStateReference()+" ";
		...
		if (company!=null && !company.equals(""))ffilterAsText+=company+" ";if (codeReference!=null && !codeReference.equals(""))ffilterAsText+=codeReference+" ";if (nameReference!=null && !nameReference.equals(""))ffilterAsText+=nameReference+" ";if (stateReference!=null && !stateReference.equals(""))ffilterAsText+=stateReference+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
