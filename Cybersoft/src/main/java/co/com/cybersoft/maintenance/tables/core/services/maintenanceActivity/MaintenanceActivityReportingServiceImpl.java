...
public class MaintenanceActivityReportingServiceImpl implements MaintenanceActivityReportingService {
	@Autowired
	...
	@Autowired
	private MaintenanceActivityService maintenanceActivity;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, MaintenanceActivityFilterInfo filter) throws Exception {
		...
		RequestMaintenanceActivityPageEvent pageEvent=new RequestMaintenanceActivityPageEvent(pageRequest,filter);			

		MaintenanceActivityPageEvent requestMaintenanceActivityFilter = maintenanceActivity.requestMaintenanceActivityFilter(pageEvent);
		
		return generateExcel(requestMaintenanceActivityFilter.getAllList(), forName, forNameDetails, locale);
	}	
