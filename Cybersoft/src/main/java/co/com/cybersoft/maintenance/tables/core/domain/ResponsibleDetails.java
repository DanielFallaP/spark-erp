...
public class ResponsibleDetails {
	...
	public ResponsibleDetails toResponsibleDetails(Responsible entity, EmbeddedField... fields){
		BeanUtils.copyProperties(entity, this);
		String _embedded="";
		for (EmbeddedField embeddedField : fields) {
			try {
				Method _method = ResponsibleDetails.class.getMethod("get"+embeddedField.getName());
