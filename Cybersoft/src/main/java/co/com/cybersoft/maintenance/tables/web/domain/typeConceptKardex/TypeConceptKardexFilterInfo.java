...
public class TypeConceptKardexFilterInfo {
	...
	private List<TypeConceptKardexFilterInfo> typeConceptKardexFilterList=new ArrayList<TypeConceptKardexFilterInfo>();
	
	public List<TypeConceptKardexFilterInfo> getTypeConceptKardexFilterList() {
		return typeConceptKardexFilterList;
	}

	public void setTypeConceptKardexFilterList(
			List<TypeConceptKardexFilterInfo> typeConceptKardexFilterList) {
		this.typeConceptKardexFilterList = typeConceptKardexFilterList;
	}
	...
	public String getFfilterAsText() {
		ffilterAsText="";
		int index=0;
		for (TypeConceptKardexFilterInfo fil : typeConceptKardexFilterList) {
		...
		if (typeConceptKardex!=null && !typeConceptKardex.equals(""))ffilterAsText+=typeConceptKardex+" ";if (active!=null && !active.equals(""))ffilterAsText+=active+" ";
