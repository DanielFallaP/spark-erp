...
public class TechnicalActionReportingServiceImpl implements TechnicalActionReportingService {
	@Autowired
	...
	@Autowired
	private TechnicalActionService technicalAction;
	
	public ExcelReportResponse toExcel(String className, String detailsClassName, Locale locale, TechnicalActionFilterInfo filter) throws Exception {
		...
		RequestTechnicalActionPageEvent pageEvent=new RequestTechnicalActionPageEvent(pageRequest,filter);			

		TechnicalActionPageEvent requestTechnicalActionFilter = technicalAction.requestTechnicalActionFilter(pageEvent);
		
		return generateExcel(requestTechnicalActionFilter.getAllList(), forName, forNameDetails, locale);
	}	
