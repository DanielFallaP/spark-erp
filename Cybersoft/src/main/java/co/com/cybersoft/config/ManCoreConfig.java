...
import co.com.cybersoft.purchase.docs.persistence.services.startup.SequenceServiceImpl;
...
public class ManCoreConfig {
	...
	@Bean
	public PurchaseOrderManService purchaseOrderManService() throws Exception{
		return new PurchaseOrderManServiceImpl();
	}
